...
function validateForm(){
  ...
  if(!emailIsValid(email.value)) {
   ...
   if(project.value.length < 1 ){
    errorNodes[2].innerText = "Mention your project";
    project.classList.add("error-border");
    errorFlag = true;
  }
  ...
  if(!errorFlag) {
  	success.innerText = "*Response is submitted*";
  }
}
...
function clearMessages(){
  ...
  project.classList.remove("error-border");
